...
namespace Asteroids.Classes
{
    class Asteroid
    {
        ...
        public Asteroid(Vector2 pos, int size, float speed, Vector2 direction, ContentManager content)
        {
            ...
            SmallAstExp = new SpritesheetLoader("SAExplosion", false, 3, content);
            MedAstExp = new SpritesheetLoader("MAExplosion", false, 3, content);
            LargeAstExp = new SpritesheetLoader("LAExplosion", false, 3, content);
        }
