...
namespace Astroids.Classes
{
    class Player
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                RocketExplosion(gameTime);
            }
            
        }
        public void RocketExplosion(GameTime gameTime)
        {
            if (lives <= 0)
            {
                playerTextureIdle = rocketExplodeSprite.tx;
                this.hitBox.Location = new Point((int)playerPos.X - playerTextureIdle.Width / 2, (int)playerPos.Y - playerTextureIdle.Height / 2);
